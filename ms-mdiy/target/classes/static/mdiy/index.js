...
(function () {
    ...
    function config(configName, key) {
        return ms.http.get(ms.base + "/mdiy/config/get.do", {configName: configName, key: key});
    }
    ...
    var dict = {
         ...
         */
        list(dictType, isChild) {
            var _dict = {
                dictType: dictType,
                isChild: isChild,
            }
            return ms.http.get('/mdiy/dict/list.do', _dict);
        },
        /**
    ...
    var model = {
         ...
         */
        async config(renderDomId, model, params, isSystem) {
         ...
         * @returns {Promise<custom_model>}
         */
        async form(renderDomId, model, params, isSystem) {
         ...
         * @returns {Promise<custom_model>}
         */
        async extend(renderDomId, model, params, isSystem) {
         ...
         */
        async render(renderDomId, model, formUrls, url, isSystem) {
            ...
            await ms.http.get(url, model).then(function (res) {
